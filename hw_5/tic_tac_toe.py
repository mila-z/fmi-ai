# evaluation function -> gives a score to each state (+1 advantage for player x, -1 advantage for player o, 0 draw)
# -> x is maximizing and o is minimizing

# alg steps:
# 1. Base case
# terminal state -> the game ended in a win, loss, draw
